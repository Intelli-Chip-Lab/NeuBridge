...
class Spiking(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.is_first:
            ...
            if self.is_second:
                with open('snn.txt', 'w') as f:
                    f.write(str(x_sum.detach().cpu().numpy()) + '\n')
...
class IF(nn.Module):
    ...
    def show_params(self):
        ...
        print('clipping activation tau: {:2f}'.format((self.act_tau))) 
